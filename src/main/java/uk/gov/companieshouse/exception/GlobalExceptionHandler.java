...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({BadRequestException.class, DissolutionNotLinkedToTransactionException.class, DissolutionInvalidSignatoriesException.class, DissolutionChangeSignatoryException.class})
