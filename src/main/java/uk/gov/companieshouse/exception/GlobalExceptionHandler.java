...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({BadRequestException.class, DissolutionNotLinkedToTransactionException.class, DissolutionInvalidSignatoriesException.class, DissolutionUpdateSignatoryException.class, DissolutionSignatoryNotFoundException.class, NotDissolutionApplicantException.class})
