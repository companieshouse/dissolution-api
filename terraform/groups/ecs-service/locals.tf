...
locals {
  ...
  lb_listener_paths          = ["/dissolution-request/*", "/dissolution-request", "/dissolution-request/*/payment", "/transactions/*/dissolution/*", "/private/transactions/*/dissolution/*/filings", "/company/*/transaction/*/dissolution"]
